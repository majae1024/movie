 ...
 * **메인 페이지**
  ...
  * **메인화면**
    * 메인 화면에서는 다음과 같은 정보를 조회할 수 있습니다:
    ...
    <img src="https://github.com/user-attachments/assets/e403863c-2eff-42cc-aca7-87d9f3a1fc2f" alt="메인화면" width="650" height="400">
  ...
  * **더 많은 영화**
    ...
    * **예매페이지**
      * `예매` 페이지에서는 차량 크기에따른 열 선택제한, 좌석 및 가격 표시, 리셋 버튼을 통해 처음부터 입력하기 편하게 사용자 친화적 경험을 제공합니다.
