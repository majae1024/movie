			...
			<div class="noticeWrite form">
				<div class="card">
                            ...
                            <div class="card-body card-block">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="user_name" class="form-control-label">작성자</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="user_name" name="user_name" readonly class="form-control" value="${username }"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="notice_text" class=" form-control-label">내용</label></div>
                                        <div class="col-12 col-md-9"><textarea name="notice_text" id="notice_text" rows="9" placeholder="공지사항 내용을 입력하세요" class="form-control"></textarea></div>
                                    </div>
